...
export function Conductor({
  ...
  return (
    <>
      ...
      <div className="absolute left-[50vw] top-[20%] z-40 -translate-x-1/2 sm:left-[46%] sm:top-[12%] sm:translate-x-0 sm:block">
        <div
          className="w-[min(220px,calc(100vw-2rem))] origin-top-right transition-all duration-500"
          style={{
            opacity: open ? 1 : 0,
